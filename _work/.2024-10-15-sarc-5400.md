...
tags:             [data, design, visualization]
title:            SARC 5400 Data Visualization
name:             SARC 5400 Data Visualization
layout:           style
description:  >-
...
A course in visualization needs to spend its time covering semiotics and language. The ability for humans to convey themselves to others. And as a corollary, as humanity has developed linguistic grammar, we also have visual grammar. As an example, think of not only how SOS sounds but also what it would look like.
...
An interesting tidbit to take away from this is that unorderly visuals are not an overload of data, a failure of design.
...
> "Tools are great. But don't let the tool drive the process. Because tools aren't great."
...
Lecture starts off with a conversation about Big Data and how correlations will replace theory. Even giving examples of many "*high-ranking*" individuals are advocating that there is no need for models, data and math. **However,** the counter force to that is highlighting **data without a model is noise.** 
...
Gave a very interesting notebook that shows the different kinds of projections in a 2D space.
