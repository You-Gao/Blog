...
In the end, it ensembles the model predictions and you end-up with a decent model. No need to understand optimization, validation, or model formula, just run an AutoML workflow. 
