...
**Combinatorics:** *ROUNDS* is not the only indie game that uses combinatorics to enable expression in the gameplay. However, it is interesting to highlight how effective this design choice is for generating player possibilities. 

## Themes and Player Experience

**Competition:** The main point of a 1v1 game like *ROUNDS* is to destroy your opponent. The underlying depth lies in the fact that within each match, you are put into mind games against the opponent and assess the skill differences in not only technique but also strategy.
