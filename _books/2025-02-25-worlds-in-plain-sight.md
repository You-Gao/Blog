...
I've always had a curiosity for unexplainable phenomena per conventional facts or models about the world. The curiosity led me to reading *Worlds Hidden in Plain Sight*[^1]. 

The book is a collection of essays or papers written by research members associated with the "*Santa Fe Institute*". All of them deal with different topics like biology, economics, politics, physics, ecology, art, and etc. What they all have in common is their "*complexity science*" approach.

Complexity science doesn't forego the scientific method. It has "*science*" in its name. The difference is complexity science aims to create digital twins or dynamic models over the experimental method. Complexity scientists build a model of phenomena based on preexisting assumptions. After model construction, they then use the standard scientific method in exploring the phenomena model.
