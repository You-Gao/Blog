...
> {% include figcaption.html caption="Edith Weisskopf-Joelson" %}

Frankl's response to my pessimism is as follows: "*As long as there is suffering there is hope*". I understand the point Frankl is going for; It's a depressing point. "*You can accept unhappiness*". The ability to affirm any circumstance is what Frankl calls the "*last of human freedoms*"[^2].
