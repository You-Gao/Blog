...
It contains a set of 30 "*fictional science*" articles. Each written to satirize scientific articles and it's format[^1]. What makes it good is how the article writers weave in technical concepts used towards absurd research programs.
...
I'll leave off with the foreword to the book: [^1]
