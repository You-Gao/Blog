...
However, I'm not going at it in a way to dunk and disregard any of the ideas, questions, and methods provided by any of these thinkers. After all, I myself believe some of these developed and exposited ideas. What I want to do with the framework is the work of translating them to the contemporary moment.
...
> "When your system breaks down, you see that the underlying structures of meaning (the contexts that render meaning) vary from place to place. The structures of meaning, like meaning itself, are not abstract or transcendental: The signified (the concept of breakfast, for example) is as material (dependent on context for its meaning) as the signifier ("breakfast" in English or Frühstück in German); the seemingly abstract and universal grammar (what you're ordering) is as concrete and changeable as the sentence or word that refers to it."
